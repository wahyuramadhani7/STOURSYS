...
<style>
    ...
    .card-hover-scale { transition: all 0.55s cubic-bezier(0.34, 1.56, 0.64, 1); }
    .card-hover-scale:hover { transform: translateY(-16px) scale(1.065); }
    ...
    .kategori-overlay {
        position: absolute;
        inset: 0;
        background: linear-gradient(to bottom, rgba(0,0,0,0.05), rgba(0,0,0,0.45)); /* lebih terang agar teks hitam terbaca */
    ...
    .kategori-icon {
        ...
        color: rgba(255,255,255,0.95); /* ikon tetap putih agar kontras */
    }
    ...
    @media (min-width: 1024px) {
        .kategori-title { font-size: 3rem; }
        .kategori-icon   { font-size: 9rem; }
    }

    /* Grid lebih lebar & max 3 kolom */
...
@section('content')
    ...
    <section class="py-16 md:py-20 bg-gradient-to-r from-orange-50 via-white to-blue-50">
        <div class="max-w-screen-2xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
            <div data-aos="fade-up" data-aos-duration="1000">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-slate-900 mb-5 tracking-tight">
                ...
                <p class="text-lg md:text-xl lg:text-2xl text-gray-700 max-w-4xl mx-auto">
    ...
    <!-- Kategori Section – judul sekarang hitam -->
    @if(!request()->has('kategori') && !request()->has('search'))
        <section class="py-16 md:py-24 bg-gray-50/70">
            <div class="max-w-screen-2xl mx-auto px-6 sm:px-8 lg:px-12">
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-center mb-16 lg:mb-20 text-slate-900" data-aos="fade-up">
                    Pilih Kategori Favoritmu
                </h2>

                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12 category-grid-wide">
                    @foreach($kategoriList as $kat)
                        <a href="{{ route('destinasi.index', ['kategori' => $kat['slug']]) }}"
                           class="kategori-card group card-hover-scale" data-aos="fade-up" data-aos-delay="{{ $loop->index * 120 }}">
                            ...
                            <div class="kategori-content">
                                ...
                                <span class="inline-block px-8 py-4 bg-white/97 text-orange-700 rounded-full font-bold text-lg shadow-xl transform group-hover:scale-110 group-hover:shadow-2xl transition-all duration-400">
                                    Jelajahi →
                                </span>
                            </div>
                        </a>
    ...
    @else
        <!-- Bagian daftar destinasi (sama seperti sebelumnya) -->
        <section class="py-12 md:py-16">
            <div class="max-w-screen-2xl mx-auto px-6 sm:px-8 lg:px-12">

                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
                    <div data-aos="fade-right">
                        <a href="{{ route('destinasi.index') }}" class="inline-flex items-center text-orange-600 hover:text-orange-800 font-medium text-xl">
                ...
                <div class="mb-12 max-w-2xl mx-auto md:mx-0" data-aos="fade-up">
                    <form method="GET" action="{{ route('destinasi.index') }}" class="relative">
                        ...
                        <button type="submit" class="absolute right-4 top-1/2 -translate-y-1/2 bg-orange-600 text-white px-8 py-3 rounded-full hover:bg-orange-700 transition-all font-semibold text-base">
                            Cari
                        </button>
                    </form>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                    @forelse ($destinasi as $index => $item)
                        <div class="group relative bg-white rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-200/40 card-hover-scale"
                             data-aos="fade-up" data-aos-duration="900" data-aos-delay="{{ $index * 100 }}">
                            ...
                            <div class="p-7">
                                ...
                                <h3 class="text-2xl font-bold text-slate-900 mb-4 group-hover:text-orange-600 transition-colors">
                                    {{ $item->nama }}
                                </h3>
                    ...
                    @empty
                        <div class="col-span-full text-center py-24" data-aos="fade-up">
                            <div class="max-w-lg mx-auto">
                                ...
                                <a href="{{ route('destinasi.index') }}" class="inline-block bg-orange-600 text-white px-10 py-5 rounded-2xl font-bold hover:bg-orange-700 transition-all shadow-xl transform hover:scale-105 text-lg">
                                    Kembali ke Kategori
                                </a>
                            </div>
                        </div>
