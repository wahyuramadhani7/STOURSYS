    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 flex flex-col" style="height: 100vh; overflow: hidden;">
            ...
            <header class="bg-[#001f3f] text-white shadow-md flex-shrink-0">
                <div class="w-full py-2.5 md:py-3 px-4 md:px-6">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <div class="flex-shrink-0">
                                <img 
                                    ...
                                    alt="Logo Candi" 
                                    class="h-12 md:h-14 lg:h-16 w-auto object-contain drop-shadow-lg"
                                >
                            </div>
                            
                            <!-- Judul di tengah -->
                            <div class="flex-1 text-center px-3">
                                <div class="flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2.5">
                                    <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-wide leading-tight">
                                        Smart Tourism System
                                    </h1>
                                    <p class="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-orange-400">
                                        (STOURSYS)
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 md:gap-4 lg:gap-5 flex-shrink-0">
                                <!-- Logo Kemendikti - BULAT -->
                                <div class="flex-shrink-0">
                                    <div class="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-full overflow-hidden bg-white flex items-center justify-center p-1.5 shadow-lg">
                                        <img 
            ...
            <nav class="bg-white shadow-lg flex-shrink-0">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between py-2">
                        ...
                        <button 
                            id="mobileMenuButton" 
                            class="lg:hidden flex items-center justify-center w-10 h-10 rounded-lg bg-blue-100 hover:bg-blue-200 text-blue-700 transition-all duration-300"
                        ...
                        <!-- Menu Items - Desktop (Hidden on Mobile) -->
                        <div class="hidden lg:flex items-center justify-center gap-2 lg:gap-3 xl:gap-4 w-full">
                            
                            <!-- Menu Destinasi -->
                            <a href="{{ route('destinasi.index') }}" class="group relative flex items-center gap-1.5 px-2 py-1.5 text-blue-700 hover:text-orange-500 transition-all duration-300 transform hover:scale-105 rounded-lg hover:bg-orange-50">
                                ...
                                <span class="text-xs lg:text-sm font-semibold tracking-wide whitespace-nowrap">Destinasi</span>
                            ...
                            <!-- Menu Event -->
                            <a href="{{ route('event.index') }}" class="group relative flex items-center gap-1.5 px-2 py-1.5 text-blue-700 hover:text-orange-500 transition-all duration-300 transform hover:scale-105 rounded-lg hover:bg-orange-50">
                                <div class="flex items-center justify-center w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-blue-100 group-hover:bg-orange-500 backdrop-blur-sm transition-all duration-300 shadow-lg flex-shrink-0">
                                    <svg class="w-4 h-4 lg:w-5 lg:h-5 text-blue-700 group-hover:text-white group-hover:rotate-12 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                </div>
                                <span class="text-xs lg:text-sm font-semibold tracking-wide whitespace-nowrap">Event</span>
                                <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-orange-500 group-hover:w-full transition-all duration-300"></div>
                            </a>

                            <!-- Menu Kontak -->
                            <a href="{{ route('kontak.index') }}" class="group relative flex items-center gap-1.5 px-2 py-1.5 text-blue-700 hover:text-orange-500 transition-all duration-300 transform hover:scale-105 rounded-lg hover:bg-orange-50">
                                <div class="flex items-center justify-center w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-blue-100 group-hover:bg-orange-500 backdrop-blur-sm transition-all duration-300 shadow-lg flex-shrink-0">
                                    <svg class="w-4 h-4 lg:w-5 lg:h-5 text-blue-700 group-hover:text-white group-hover:rotate-12 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                    </svg>
                                </div>
                                <span class="text-xs lg:text-sm font-semibold tracking-wide whitespace-nowrap">Kontak</span>
                                <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-orange-500 group-hover:w-full transition-all duration-300"></div>
                            </a>

                            <!-- Menu Panduan -->
                            <a href="{{ route('panduan.index') }}" class="group relative flex items-center gap-1.5 px-2 py-1.5 text-blue-700 hover:text-orange-500 transition-all duration-300 transform hover:scale-105 rounded-lg hover:bg-orange-50">
                                <div class="flex items-center justify-center w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-blue-100 group-hover:bg-orange-500 backdrop-blur-sm transition-all duration-300 shadow-lg flex-shrink-0">
                                    <svg class="w-4 h-4 lg:w-5 lg:h-5 text-blue-700 group-hover:text-white group-hover:rotate-12 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                                    </svg>
                                </div>
                                <span class="text-xs lg:text-sm font-semibold tracking-wide whitespace-nowrap">Panduan</span>
                                <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-orange-500 group-hover:w-full transition-all duration-300"></div>
                            </a>

                            <!-- Menu Berita -->
                            <a href="{{ route('berita.index') }}" class="group relative flex items-center gap-1.5 px-2 py-1.5 text-blue-700 hover:text-orange-500 transition-all duration-300 transform hover:scale-105 rounded-lg hover:bg-orange-50">
                                <div class="flex items-center justify-center w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-blue-100 group-hover:bg-orange-500 backdrop-blur-sm transition-all duration-300 shadow-lg flex-shrink-0">
                                    <svg class="w-4 h-4 lg:w-5 lg:h-5 text-blue-700 group-hover:text-white group-hover:rotate-12 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/>
                                    </svg>
                                </div>
                                <span class="text-xs lg:text-sm font-semibold tracking-wide whitespace-nowrap">Berita</span>
                                <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-orange-500 group-hover:w-full transition-all duration-300"></div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
                        <div class="flex items-center gap-2 md:gap-3">
                            <img 
                                ...
                                class="h-8 w-8 md:h-10 md:w-10 object-contain flex-shrink-0"
                            />
                            <div>
                                <h3 class="text-xs md:text-base lg:text-lg font-bold tracking-wide">
