...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            /* =====================================================
               Tepat mengisi layar tanpa scroll, pull-to-refresh tetap jalan
            ===================================================== */
            html, body {
                margin: 0;
                padding: 0;
                width: 100%;
                height: 100%;
                /* Tidak pakai overflow:hidden — itu yang blokir pull-to-refresh */
            }
            ...
            /* Wrapper utama tepat mengisi 100% viewport */
            .layout-wrapper {
                height: 100vh;
                height: 100dvh;
                display: flex;
                flex-direction: column;
                /* overscroll-behavior menggantikan overflow:hidden —
                   mencegah bounce/scroll berlebih tapi TIDAK blokir pull-to-refresh */
                overscroll-behavior: none;
            }

            /* Header & footer tidak boleh shrink */
            .layout-wrapper > header,
            .layout-wrapper > footer {
                flex-shrink: 0;
            }

            /* Nav tidak boleh shrink */
            .layout-wrapper > nav {
                flex-shrink: 0;
            }

            /* Main mengisi SEMUA sisa ruang */
            .layout-wrapper > main {
                flex: 1 1 0;
                min-height: 0;
                margin: 0;
    ...
    <body class="font-sans antialiased">
        <div class="layout-wrapper">
            ...
            <header class="bg-[#001f3f] text-white shadow-md">
                <div class="w-full py-5 sm:py-6 md:py-8 lg:py-10 px-3 sm:px-4 md:px-6">
                    <div class="max-w-7xl mx-auto">
                        <div class="flex items-center justify-between gap-2 sm:gap-2 md:gap-3">
                            ...
                            <div class="flex-shrink-0">
                                <img
                                    ...
                                    alt="Logo Candi"
                                    class="h-16 sm:h-20 md:h-24 lg:h-28 xl:h-32 w-auto object-contain drop-shadow-lg"
                                >
                            </div>
                            ...
                            <div class="flex-1 text-center px-2 sm:px-3 min-w-0">
                                <div class="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-1.5 md:gap-2.5">
                                    <h1 class="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black tracking-wide leading-tight">
                                        Smart Tourism System
                                    </h1>
                                    <p class="text-base sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-semibold text-orange-400">
                                        (STOURSYS)
                                    </p>
                                </div>
                            </div>
                            ...
                            <!-- Logo kanan -->
                            <div class="flex items-center gap-2 sm:gap-2 md:gap-3 lg:gap-5 flex-shrink-0">
                                <div class="flex-shrink-0">
                                    <div class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full overflow-hidden bg-white flex items-center justify-center p-1.5 sm:p-2 shadow-lg">
                                        <img
                    ...
                    <div id="mobileMenu" class="lg:hidden hidden overflow-hidden transition-all duration-300">
                        <div class="py-2 space-y-1">
                            ...
                            <a href="{{ route('berita.index') }}" class="flex items-center gap-3 px-4 py-3 text-blue-700 hover:text-orange-500 hover:bg-orange-50 transition-all duration-200 rounded-lg">
                                <div class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 flex-shrink-0">
                                    <svg class="w-5 h-5 text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                                </div>
            ...
            <footer class="bg-[#001f3f] text-white">
                ...
                <div class="py-4 md:py-5 px-3 sm:px-4 md:px-6">
                    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2 md:gap-3">
                        <div class="flex items-center gap-2 md:gap-3">
                            <img
                                src="{{ asset('storage/images/logotutwuri.png') }}"
                                alt="Logo Kemendikbud"
                                class="h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 object-contain flex-shrink-0"
                            />
                            <div class="text-center md:text-left">
                                <h3 class="text-sm sm:text-base md:text-lg font-bold tracking-wide">
